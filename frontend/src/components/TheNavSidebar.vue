    ...
    <ul class="nav nav-pills d-flex flex-column">
      ...
      <li class = "nav-item">
        <a href="/administrace/properties" class="nav-link {% if url_name == 'userMng:user_properties' %}active{% endif %}">
          ...
          <li class = "nav-item">
        <a href="{% url 'pinax_messages:inbox' %}" class="nav-link {% if url_name == 'pinax_messages:inbox' %}active{% endif %}">
      ...
      {% if request.user.is_active and request.user.is_staff %}
        <li class="horizontal_line d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">Advertising</li>
        <li class = "nav-item">
          <a href="{% url 'userMng:my_property_ads' %}" class="nav-link {% if url_name == 'userMng:my_property_ads' %}active{% endif %}">
            <i class="fas fa-ad fa-lg"></i>
            <span class="ml-3">My property ads</span>
          </a>
        </li>
        <li class = "nav-item">
          <a href="{% url 'userMng:ad_statistics' %}" class="nav-link {% if url_name == 'userMng:ad_statistics' %}active{% endif %}">
