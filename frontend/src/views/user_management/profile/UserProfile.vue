	...
	<div class="row">
		...
		<div class="row col-md-9 col-lg-9 col-xl-10 pt-3">
			<div class="col-xs-12 col-md-5 col-lg-5 col-xl-3 pr-2">
				<div class="col-md-12">
					<img src="{% firstof user.image.user_profile_image.url gravatar_url %}" alt="My Profile picture" class="rounded img-fluid">

					<img src="{{ gravatar_url }}" alt="My Profile picture" class="rounded img-fluid">
				</div>
				<div class="col-md-12">
					<div class="pt-2">
						<form class="" action="POST" id = "form-user-profile-image" enctype="multipart/form-data">
						{% csrf_token %}
							<div class="input-group mb-3">
								<div class="custom-file">
									<input type="file" name="image" class="custom-file-input" id="customFile">
									<label class="custom-file-label" for="customFile" aria-describedby="inputGroupFileAddon02">Image...</label>
								</div>
								<div class="input-group-append">
									<button type="submit" class="btn input-group-text" id="inputGroupFileAddon02">Upload</button>
								</div>
							</div>
						</form>
					</div>
			...
			<div class="col-xs-12 col-md-7 col-lg-7 col-xl-9 pt-2">
				...
				{% csrf_token %}		
					...
					<div class="form-row">
						...
						<div class="form-group col-xs-5 col-sm-6 col-md-12 col-lg-6 col-xl-4">
							{{ form.user_country.label_tag }}
							{{ form.user_country.errors }}
