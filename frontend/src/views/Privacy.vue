  ...
  <div class="privacy">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <h2>1. What ?</h2>
          <p>This Site ("us", "we", "service", or "our") operates the <router-link to="/">https://melive.xyz</router-link> website.</p>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <h5>2.3 Tracking & Cookies Data</h5>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <p>This site uses the collected data for various purposes:</p>
          <ul>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <p>If you are located outside EU and choose to provide information to us, please note that we transfer the data, including Personal Data, to EU and process it there.</p>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <p>This site may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
          <ul>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <p>Our service must not be used under the age of 18 ("Children").</p>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <p>We update our Privacy Policy from time to time and we will notify you of any changes by posting the new Privacy Policy on this page.</p>
